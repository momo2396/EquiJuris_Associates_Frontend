...
const LoginForm = () => {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2">
      ...
      <div className="py-36 lg:py-72 bg-[#161D27] text-white">
        <h1 className="text-center text-3xl pb-5 text-[#D1B06B]">Login Here</h1>
        <div className="py-10 px-5 mx-10 border-2 border-slate-400 rounded-xl">
          ...
          <div className="pt-5 flex flex-col lg:flex-row items-center gap-5">
            <button className="btn bg-[#1F2732] border-[#1F2732] text-white hover:text-black hover:bg-[#D1B06B] hover:border-[#D1B06B]">
              Login
            </button>
            <p>
              Don't you have any account? Please{" "}
              <span>
                <a className="underline text-[#D1B06B]" href="">
                  Sign Up
                </a>
              </span>
            </p>

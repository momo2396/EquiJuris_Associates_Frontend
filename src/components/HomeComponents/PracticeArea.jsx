        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          <div className="card bg-[#1F2732] shadow-xl border-2 border-[#D1B06B] rounded-md">
            <div className="card-body">
              ...
              <p>
                ...
                entities, including company formation, contracts, mergers and
          ...
          <div className="card bg-[#1F2732] shadow-xl border-2 border-[#D1B06B] rounded-md">
            <div className="card-body">
              ...
              <p>
                ...
                including issues related to contracts, property, family matters,
                and torts.
              </p>
              <div className="border border-gray-700 mt-5"></div>
              <div className="flex justify-between items-center card-actions mt-10">
          ...
          <div className="card bg-[#1F2732] shadow-xl border-2 border-[#D1B06B] rounded-md">
            <div className="card-body">
              ...
              <p>
                ...
                and includes crimes such as theft, murder, fraud, and other
                criminal activities. It encompasses the Bangladesh Penal Code
          ...
          <div className="card bg-[#1F2732] shadow-xl border-2 border-[#D1B06B] rounded-md">
            <div className="card-body">
              ...
              <p>
                Labor laws govern the rights and responsibilities of workers and
                employers. These laws cover areas such as employment conditions,
                wages, benefits, and labor disputes.
              </p>
              <div className="border border-gray-700 mt-5"></div>
              <div className="flex justify-between items-center card-actions mt-10">
                <BsBagDash className="text-4xl font-bold text-[#D1B06B]" />
          ...
          <div className="card bg-[#1F2732] shadow-xl border-2 border-[#D1B06B] rounded-md">
            <div className="card-body">
              ...
              <p>
                This area covers regulations and practices in the banking and
                financial sectors, including banking laws, securities
          ...
          <div className="card bg-[#1F2732] shadow-xl border-2 border-[#D1B06B] rounded-md">
            <div className="card-body">
              ...
              <p>
                Administrative law deals with the legal principles governing the
                actions and decisions of government authorities and public
                officials.
              </p>
              <div className="border border-gray-700 mt-5"></div>
              <div className="flex justify-between items-center card-actions mt-10">

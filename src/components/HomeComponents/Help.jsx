...
const Help = () => {
  return (
    <section className="py-20">
      <h3 className="pb-10 text-3xl font-bold font-titleFont text-center max-w-[753px]mx-auto">
        If you're in trouble<br></br> we can help.
      </h3>
      <p className="text-center max-w-[753px] mx-auto text-[#909090] font-titleFont text-lg">
      ...
      <div className="max-w-[1200px] mx-auto px-5 pt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-center gap-5 ">
        <div className="bg-gray-100 border py-3 px-5 flex items-center gap-3">
          ...
          <div>
            <h2 className="font-titleFont text-lg font-bold">
              Trusted Clients
            </h2>

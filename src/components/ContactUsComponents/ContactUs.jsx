          ...
          <div className="container flex flex-col justify-center p-4 mx-auto md:p-8">
            <div className="flex flex-col divide-y sm:px-8 lg:px-12 xl:px-32 dark:divide-gray-700">
              ...
              <details>
                ...
                <div className="px-4 pb-4">
                  <p>
                    ...
                    researching and picking a name for your business or
                    reserving a domain.
                  </p>
                </div>
              </details>
              <details>
                ...
                <div className="px-4 pb-4">
                  <p>
                    No one can stop a lawsuit from being filed. However, if
                    there is a legitimate dispute that arises and a claim made
                    against you, consult a lawyer behind-the-scenes work is
                    being completed so that on the day your matter is ready,
              ...
              <details>
                ...
                <div className="px-4 pb-4">
                  <p>
                    ...
                    issues within the marriage, including property, finances,
                    and child-related issues. This is the most common way to
                    deal with marital issues, as Florida does not recognize
                    legal separation.
                  </p>
                </div>
              </details>
              <details>
                ...
                <div className="px-4 pb-4 space-y-2">
                  <p>
                    ...
                    having the help of an attorney with family law experience
                    can go a long way toward protecting your interests.
                    Florida’s family laws have developed over many decades and
                    are complicated.
                  </p>
                </div>
              </details>
